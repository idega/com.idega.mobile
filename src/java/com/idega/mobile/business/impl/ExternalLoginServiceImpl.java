 ...
 */
package com.idega.mobile.business.impl;
 ...
 */
@Service(ExternalLoginService.BEAN_NAME)
@Scope(BeanDefinition.SCOPE_SINGLETON)
public class ExternalLoginServiceImpl extends DefaultSpringBean implements ExternalLoginService{
	...
	public User loginToFacebook(String email, String password) {
		...
		try {
			accessToken = facebookClient
				.obtainAppAccessToken(email, password);
		} catch (Exception e) {
			getLogger().log(
					Level.WARNING, 
